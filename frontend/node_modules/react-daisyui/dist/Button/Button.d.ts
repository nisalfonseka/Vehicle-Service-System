...
declare const _default: <T extends React.ElementType<any, keyof React.JSX.IntrinsicElements> = "button", E extends HTMLElement = GetTagProps<T>["ele"], A extends React.HTMLAttributes<HTMLElement> = GetTagProps<T>["attr"]>(props: Omit<A, "size" | "color"> & IComponentBaseProps & {
