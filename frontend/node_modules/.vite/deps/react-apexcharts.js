import {
  require_prop_types
} from "./chunk-QQJQJD3Z.js";
import "./chunk-UNDKXA73.js";
import {
  require_react
  ...
  "node_modules/apexcharts/dist/apexcharts.common.js"(exports, module) {
    ...
    var y = function() {
      ...
      return s(t2, [{ key: "getDefaultFilter", value: function(t3, e2) {
        ...
        if (t3.unfilter(true), v.isMsEdge() && "radialBar" === d2.config.chart.type)
          return t3;
    ...
    var w = function() {
      ...
      return s(t2, [{ key: "roundPathCorners", value: function(t3, e2) {
        ...
        if (z2.attr("index", a2), x2 && z2.attr({ "clip-path": "url(#gridRectMask".concat(A2.globals.cuid, ")") }), "none" !== A2.config.states.normal.filter.type)
          S2.getDefaultFilter(z2, a2);
        ...
        return Array.isArray(s2) ? w2 = m2.globals.dom.Paper.text(function(t4) {
          for (var i3 = 0; i3 < s2.length; i3++)
            y2 = s2[i3], g2 && (y2 = e2.getTextBasedOnMaxWidth(d({ text: s2[i3] }, k2))), 0 === i3 ? t4.tspan(y2) : t4.tspan(y2).newLine();
      ...
      return s(t2, [{ key: "setOrientations", value: function(t3) {
        ...
        if (this.annoCtx.invertAxis) {
          ...
          if (r2.config.yaxis[e2.yAxisIndex].logarithmic)
            h2 = (a2 = new k(this.annoCtx.ctx).getLogVal(r2.config.yaxis[e2.yAxisIndex].logBase, a2, c2)) / r2.globals.yLogRatio[c2];
          else
    ...
    var O = function() {
      ...
      return s(t2, [{ key: "clippedImgArea", value: function(t3) {
        ...
        if (void 0 === r2.gradient.gradientToColors || 0 === r2.gradient.gradientToColors.length)
          o2 = "dark" === r2.gradient.shade ? h2.shadeColor(-1 * parseFloat(r2.gradient.shadeIntensity), e2.indexOf("rgb") > -1 ? v.rgb2hex(e2) : e2) : h2.shadeColor(parseFloat(r2.gradient.shadeIntensity), e2.indexOf("rgb") > -1 ? v.rgb2hex(e2) : e2);
        ...
        for (var x2 = 0; x2 < a2.x.length; x2++)
          if (g2 = a2.x[x2] + d2.offsetX, u2 = a2.y[x2] + d2.offsetY + l2, !isNaN(g2)) {
            ...
            if ("bubble" === h2.config.chart.type)
              v2 = m2(b2 = h2.globals.seriesZ[s2][p2]), u2 = a2.y[x2], u2 = new W(this.ctx).centerTextInBubble(u2, s2, p2).y;
            else
              void 0 !== b2 && (v2 = m2(b2));
    ...
    var V = function() {
      ...
      return s(t2, [{ key: "isMultiFormat", value: function() {
        ...
        for (var o2 = 0; o2 < t3[e2].data.length; o2++)
          void 0 !== t3[e2].data[o2].y && (Array.isArray(t3[e2].data[o2].y) ? this.twoDSeries.push(v.parseNumber(t3[e2].data[o2].y[t3[e2].data[o2].y.length - 1])) : this.twoDSeries.push(v.parseNumber(t3[e2].data[o2].y))), void 0 !== t3[e2].data[o2].goals && Array.isArray(t3[e2].data[o2].goals) ? (void 0 === this.seriesGoals[e2] && (this.seriesGoals[e2] = []), this.seriesGoals[e2].push(t3[e2].data[o2].goals)) : (void 0 === this.seriesGoals[e2] && (this.seriesGoals[e2] = []), this.seriesGoals[e2].push(null));
      ...
      return s(t2, [{ key: "drawGridArea", value: function() {
        ...
        if (void 0 !== i2.config.grid.column.colors && i2.config.grid.column.colors.length > 0) {
          ...
          for (var h2 = i2.globals.padHorizontal, c2 = i2.globals.padHorizontal + i2.globals.gridWidth / l2, d2 = i2.globals.gridHeight, g2 = 0, u2 = 0; g2 < t3; g2++, u2++) {
            var p2;
            if (u2 >= i2.config.grid.column.colors.length && (u2 = 0), "datetime" === i2.config.xaxis.type)
              h2 = this.xaxisLabels[g2].position, c2 = ((null === (p2 = this.xaxisLabels[g2 + 1]) || void 0 === p2 ? void 0 : p2.position) || i2.globals.gridWidth) - this.xaxisLabels[g2].position;
    ...
    var q = function() {
      ...
      return s(t2, [{ key: "niceScale", value: function(t3, e2) {
          ...
          if (d2)
            if (c2)
              if (0 != v.mod(x2, b2)) {
                ...
                0 == v.mod(b2, S2) ? b2 = S2 : (S2 = b2, d2 = false);
            else
              b2 = S2;
          else if (c2)
            0 == v.mod(x2, b2) ? S2 = b2 : b2 = S2;
          ...
          t:
            for (var Y2 = 0; Y2 < X2; Y2++)
              for (var F2 = 0; F2 <= X2 - Y2; F2++) {
                for (var R2 = Math.min(F2 + Y2, X2), D2 = E2, H2 = 1, O2 = F2; O2 <= R2; O2++)
                  H2 *= z2[O2];
                if ((D2 /= H2) < a2) {
                  E2 = D2;
                  break t;
        ...
        for (var n2 = t3; i2 >= 0; )
          o2.push(n2), n2 = v.preciseAddition(n2, s2), i2 -= 1;
        ...
        if (0 !== a2.responsive.length) {
          ...
          var r2 = new R({}), o2 = function() {
            ...
            if (o3 > a3) {
              ...
              for (var h2 = 0; h2 < s2.length; h2++)
                o3 < s2[h2].breakpoint && (t4 = k.extendArrayProps(r2, s2[h2].options, i2), t4 = v.extend(i2.config, t4), e2.overrideResponsiveOptions(t4));
          };
          if (t3) {
    ...
    var ct = function() {
      ...
      return s(t2, [{ key: "init", value: function() {
        ...
        if (g2.height = 2 * (n2 + c2) + "px", g2.width = 2 * (n2 + c2) + "px", g2.left = l2 + "px", g2.top = h2 + "px", a2.config.legend.markers.customHTML)
          g2.background = "transparent", g2.color = i2[e2], Array.isArray(a2.config.legend.markers.customHTML) ? a2.config.legend.markers.customHTML[e2] && (s2.innerHTML = a2.config.legend.markers.customHTML[e2]()) : s2.innerHTML = a2.config.legend.markers.customHTML();
        else {
        ...
        if ("heatmap" === e2.config.chart.type || this.isBarsDistributed) {
          ...
          !t3.target.classList.contains("apexcharts-inactive-legend") && i2 && new G(this.ctx).toggleSeriesOnHover(t3, t3.target);
    ...
    var dt = function() {
      ...
      return s(t2, [{ key: "createToolbar", value: function() {
        ...
        for (var h2 = 0; h2 < r2.length; h2++)
          w.setAttrs(r2[h2].el, { class: r2[h2].class, title: r2[h2].title }), r2[h2].el.innerHTML = r2[h2].icon, a2.appendChild(r2[h2].el);
        ...
        for (var e2 = [{ name: "exportSVG", title: this.localeValues.exportToSVG }, { name: "exportPNG", title: this.localeValues.exportToPNG }, { name: "exportCSV", title: this.localeValues.exportToCSV }], i2 = 0; i2 < e2.length; i2++)
          this.elMenuItems.push(document.createElement("div")), this.elMenuItems[i2].innerHTML = e2[i2].title, w.setAttrs(this.elMenuItems[i2], { class: "apexcharts-menu-item ".concat(e2[i2].name), title: e2[i2].title }), this.elMenu.appendChild(this.elMenuItems[i2]);
      ...
      return s(t2, [{ key: "drawSeriesTexts", value: function(t3) {
        ...
        for (var v2 = function(t4, r3) {
          ...
          if (h2.globals.axisCharts) {
            ...
            if (n2)
              v3 = i2.getFormatters(m3), x2 = i2.getSeriesName({ fn: v3.yLbTitleFormatter, index: m3, seriesIndex: a2, j: s2 }), b2 = h2.globals.colors[m3], e2 = y3(m3), g2(m3) && (c2 = h2.globals.seriesGoals[m3][s2].map(function(t5) {
      ...
      return s(t2, [{ key: "getElTooltip", value: function(t3) {
        ...
        if (o2) {
          if (i2.tooltipRect = { x: 0, y: 0, ttWidth: o2.getBoundingClientRect().width, ttHeight: o2.getBoundingClientRect().height }, i2.e = s2, i2.tooltipUtil.hasBars() && !r2.globals.comboCharts && !i2.isBarShared) {
            if (this.tConfig.onDatasetHover.highlightDataSeries)
              new G(e2).toggleSeriesOnHover(s2, s2.target.parentNode);
          }
        ...
        if (this.clientY = l2, this.clientX = n2, r2.globals.capturedSeriesIndex = -1, r2.globals.capturedDataPointIndex = -1, l2 < o2.top || l2 > o2.top + o2.height)
          ...
          if ("mousemove" === a2.type || "touchmove" === a2.type || "mouseup" === a2.type) {
            ...
            if (null !== this.ycrosshairs && p2.length && this.ycrosshairs.classList.add("apexcharts-active"), u2 && !this.showOnIntersect || g2.length > 1)
        ...
        for (var t3 = this.w, e2 = new w(this.ctx), i2 = t3.globals.dom.Paper.select(".apexcharts-bar-area"), a2 = 0; a2 < i2.length; a2++)
        ...
        if (A2) {
          if (C2.tooltipLabels.drawSeriesTexts(d(d({}, F2), {}, { shared: !this.showOnIntersect && this.tConfig.shared })), L2)
          ...
          C2.tooltipLabels.drawSeriesTexts(d({ shared: false }, F2)), this.tooltipUtil.hasBars() && C2.tooltipPosition.moveStickyTooltipOverBars(a2, i2), L2 && C2.tooltipPosition.moveMarkers(i2, a2);
      } }]), t2;
    }();
    var yt = function() {
      function t2(e2) {
      ...
      return s(t2, [{ key: "handleBarDataLabels", value: function(t3) {
        ...
        if (h2.enabled && !b2) {
          ...
          if ("vertical" === c2.config.plotOptions.bar.dataLabels.orientation && ("top" === y2 && (h2.textAnchor = m2 ? "end" : "start"), "center" === y2 && (h2.textAnchor = "middle"), "bottom" === y2 && (h2.textAnchor = m2 ? "end" : "start")), this.barCtx.isRangeBar && this.barCtx.barOptions.dataLabels.hideOverflowingLabels)
            l2 < p2.getTextRects(v2, parseFloat(h2.style.fontSize)).width && (v2 = "");
    ...
    var At = function(t2) {
      ...
      return s(a2, [{ key: "draw", value: function(t3, e3) {
        ...
        for (var e3, i2 = t3.indexes, a3 = t3.barHeight, s2 = t3.strokeWidth, r2 = t3.zeroW, o2 = t3.x, n2 = t3.y, l2 = t3.columnGroupIndex, h2 = t3.seriesGroup, c2 = t3.yDivision, d2 = t3.elSeries, g2 = this.w, u2 = n2 + l2 * a3, p2 = i2.i, f2 = i2.j, x2 = i2.realIndex, b2 = i2.translationsIndex, v2 = 0, m2 = 0; m2 < this.groupCtx.prevXF.length; m2++)
          v2 += this.groupCtx.prevXF[m2][f2];
        var y2;
        ...
        for (var h2 = n2 ? 0 : l2.length - 1; n2 ? h2 < l2.length : h2 >= 0; n2 ? h2++ : h2--) {
          ...
          for (var g2 = 0, u2 = e2.config.plotOptions.heatmap.shadeIntensity, p2 = 0; p2 < l2[h2].length; p2++) {
            ...
            if ("image" === e2.config.fill.type)
              x2 = new O(this.ctx).fillPath({ seriesNumber: h2, dataPointIndex: p2, opacity: e2.globals.hasNegs ? b2.percent < 0 ? 1 - (1 + b2.percent / 100) : u2 + b2.percent / 100 : b2.percent / 100, patternID: v.randomId(), width: e2.config.fill.image.width ? e2.config.fill.image.width : s2, height: e2.config.fill.image.height ? e2.config.fill.image.height : r2 });
      ...
      return s(t2, [{ key: "draw", value: function(t3) {
        ...
        if (i2.globals.dataChanged) {
          for (var d2, g2 = 0, u2 = 0; u2 < i2.globals.previousPaths.length; u2++)
            g2 += v.negToZero(i2.globals.previousPaths[u2]);
          for (var p2 = 0; p2 < i2.globals.previousPaths.length; p2++)
            d2 = this.fullAngle * v.negToZero(i2.globals.previousPaths[p2]) / g2, this.prevSectorAngleArr.push(d2);
        }
        ...
        if (0 !== s2.strokeWidth) {
          for (var r2 = [], o2 = 360 / i2.globals.series.length, n2 = 0; n2 < i2.globals.series.length; n2++)
            r2.push(v.polarToCartesian(this.centerX, this.centerY, i2.globals.radialSize, i2.config.plotOptions.pie.startAngle + o2 * n2));
    ...
    var It = function() {
      ...
      return s(t2, [{ key: "draw", value: function(t3) {
        ...
        for (var e2 = this, i2 = this.w, a2 = t3.parent, s2 = new Pt(this.ctx), r2 = i2.globals.yAxisScale[0].result.reverse(), o2 = r2.length, n2 = [], l2 = this.size / (o2 - 1), h2 = 0; h2 < o2; h2++)
          n2[h2] = l2 * h2;
        n2.reverse();
        var c2 = [], d2 = [];
    ...
    var Tt = function(t2) {
      ...
      return s(o2, [{ key: "draw", value: function(t3) {
        ...
        if (s2.config.plotOptions.radialBar.hollow.imageClipped)
          r2.clippedImgArea({ width: i2, height: i2, image: n2, patternID: "pattern".concat(s2.globals.cuid).concat(o3) }), a3 = "url(#pattern".concat(s2.globals.cuid).concat(o3, ")");
        else {
    ...
    var Xt = function() {
      ...
      return s(t2, [{ key: "sameValueSeriesFix", value: function(t3, e2) {
        ...
        if (0 === o2) {
          ...
          h2.push(a2 + l2.config.markers.offsetX), c2.push(v.isNumber(e2[r2][o2 + 1]) ? s2 + l2.config.markers.offsetY : null);
        return { x: h2, y: c2 };
    ...
    var Et = function(t2) {
      for (var e2, i2, a2, s2, r2 = function(t3) {
        for (var e3 = [], i3 = t3[0], a3 = t3[1], s3 = e3[0] = Rt(i3, a3), r3 = 1, o3 = t3.length - 1; r3 < o3; r3++)
          i3 = a3, a3 = t3[r3 + 1], e3[r3] = 0.5 * (s3 + (s3 = Rt(i3, a3)));
        return e3[r3] = s3, e3;
      }(t2), o2 = t2.length - 1, n2 = [], l2 = 0; l2 < o2; l2++)
        a2 = Rt(t2[l2], t2[l2 + 1]), Math.abs(a2) < 1e-6 ? r2[l2] = r2[l2 + 1] = 0 : (s2 = (e2 = r2[l2] / a2) * e2 + (i2 = r2[l2 + 1] / a2) * i2) > 9 && (s2 = 3 * a2 / Math.sqrt(s2), r2[l2] = s2 * e2, r2[l2 + 1] = s2 * i2);
    ...
    var Dt = function() {
      ...
      return s(t2, [{ key: "draw", value: function(t3, e2, i2, a2) {
        ...
        for (var c2 = [], g2 = 0; g2 < t3.length; g2++) {
          ...
          if ("rangeArea" === n2) {
            for (var X2 = this._calculatePathsFrom({ series: a2, i: g2, realIndex: u2, prevX: S2, prevY: L2 }), E2 = this._iterateOverDataPoints(d(d({}, T2), {}, { series: a2, xArrj: [v2], yArrj: M2, y2Arrj: I2, pY: A2, areaPaths: z2.areaPaths, pathsFrom: X2, iterations: a2[g2].length - 1, isRangeStart: false })), Y2 = z2.linePaths.length / 2, F2 = 0; F2 < Y2; F2++)
        ...
        if (void 0 !== (null === (s2 = r2.config.series[0]) || void 0 === s2 ? void 0 : s2.zIndex) && c2.sort(function(t4, e3) {
          ...
          for (var R2 = c2.length - 1; R2 >= 0; R2--)
            l2.add(c2[R2]);
        else
        ...
        if ("area" === e2)
          for (var p2 = n2.fillPath({ seriesNumber: i2 }), f2 = 0; f2 < s2.areaPaths.length; f2++) {
          ...
          case "smooth":
            ...
            if (null === i2[a2][s2])
              ...
              switch (u2) {
                ...
                case 1:
                  if (null === i2[a2][s2 + 1])
                    f2 += L2 ? A2.line(d2, h2) : A2.move(d2, g2), x2 += A2.line(d2, S2) + A2.line(p2, S2) + "z", b2.push(f2), v2.push(x2), u2 = -1;
                  else {
    ...
    var Gt = function() {
      ...
      return s(t2, [{ key: "calculateTimeScaleTicks", value: function(t3, e2) {
        ...
        if (e2.minDate > 1 || e2.minMonth > 0) {
          ...
          1 === e2.minDate && 0 === e2.minMonth && this.timeScaleArray.push({ position: n2, value: o2, unit: h2, year: a2, month: v.monthMod(i2 + 1) });
        ...
        if (e2.minDate > 1) {
          ...
          this.timeScaleArray.push({ position: l2, value: n2, unit: c2, year: s2, month: v.monthMod(a2) });
        ...
        for (var e2 = t3.currentMillisecond, i2 = t3.currentSecond, a2 = t3.currentMinute, s2 = t3.currentHour, r2 = t3.currentDate, o2 = t3.currentMonth, n2 = t3.currentYear, l2 = t3.minutesWidthOnXAxis, h2 = t3.secondsWidthOnXAxis, c2 = t3.numberOfMinutes, d2 = a2 + 1, g2 = r2, u2 = o2, p2 = n2, f2 = s2, x2 = (60 - i2 - e2 / 1e3) * h2, b2 = 0; b2 < c2; b2++)
          d2 >= 60 && (d2 = 0, 24 === (f2 += 1) && (f2 = 0)), this.timeScaleArray.push({ position: x2, value: d2, unit: "minute", hour: f2, minute: d2, day: g2, year: this._getYear(p2, u2, 0), month: v.monthMod(u2) }), x2 += l2, d2++;
      } }, { key: "generateSecondScale", value: function(t3) {
        for (var e2 = t3.currentMillisecond, i2 = t3.currentSecond, a2 = t3.currentMinute, s2 = t3.currentHour, r2 = t3.currentDate, o2 = t3.currentMonth, n2 = t3.currentYear, l2 = t3.secondsWidthOnXAxis, h2 = t3.numberOfSeconds, c2 = i2 + 1, d2 = a2, g2 = r2, u2 = o2, p2 = n2, f2 = s2, x2 = (1e3 - e2) / 1e3 * l2, b2 = 0; b2 < h2; b2++)
          c2 >= 60 && (c2 = 0, ++d2 >= 60 && (d2 = 0, 24 === ++f2 && (f2 = 0))), this.timeScaleArray.push({ position: x2, value: c2, unit: "second", hour: f2, minute: d2, second: c2, day: g2, year: this._getYear(p2, u2, 0), month: v.monthMod(u2) }), x2 += l2, c2++;
      ...
      return s(t2, [{ key: "setupElements", value: function() {
        ...
        if (s2.comboCharts) {
          ...
          if (o2.series.length > 0)
            (S2 = A2).push.apply(S2, p(L2.drawSeriesByGroup(o2, s2.areaGroups, "area", v2)));
          if (h2.series.length > 0)
            if (i2.config.chart.stacked) {
              var P2 = new At(this.ctx, e2);
              A2.push(P2.draw(h2.series, h2.i));
            } else
              this.ctx.bar = new kt(this.ctx, e2), A2.push(this.ctx.bar.draw(h2.series, h2.i));
          if (u2.series.length > 0 && A2.push(v2.draw(u2.series, "rangeArea", u2.i, u2.seriesRangeEnd)), r2.series.length > 0)
            (C2 = A2).push.apply(C2, p(L2.drawSeriesByGroup(r2, s2.lineGroups, "line", v2)));
          ...
          switch (a2.chart.type) {
            ...
            case "bar":
              if (a2.chart.stacked)
                A2 = new At(this.ctx, e2).draw(s2.series);
              else
                this.ctx.bar = new kt(this.ctx, e2), A2 = this.ctx.bar.draw(s2.series);
              break;
            case "candlestick":
    ...
    Ht = "undefined" != typeof window ? window : void 0, Ot = function(t2, e2) {
      ...
      i2.PathArray = function(t3, e3) {
        ...
        if (!("object" !== x(t3) || t3 instanceof i2.Element))
      ...
      function f2(e3) {
        for (var a3 = e3.childNodes.length - 1; a3 >= 0; a3--)
          e3.childNodes[a3] instanceof t2.SVGElement && f2(e3.childNodes[a3]);
