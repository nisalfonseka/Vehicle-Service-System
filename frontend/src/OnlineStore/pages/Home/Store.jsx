  ...
  return (
    ...
    <div>
      <div className='headerx'>
        ...
        <Link to="/CardManagementPage" className="btn btn-secondary" id='profil'>
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-person-circle" viewBox="0 0 16 16">
              <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0"/>
              <path fillRule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8m8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1"/>
          </svg>
        </Link>
        <Link to="/cart" className="btn btn-secondary" id='cart'>
          ...
          <Link to="/my-orders" className="btn btn-secondary" id='cart'>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-cart-dash" viewBox="0 0 16 16">
                <path d="M6.5 7a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1z"/>
                <path d="M.5 1a.5.5 0 0 0 0 1h1.11l.401 1.607 1.498 7.985A.5.5 0 0 0 4 12h1a2 2 0 1 0 0 4 2 2 0 0 0 0-4h7a2 2 0 1 0 0 4 2 2 0 0 0 0-4h1a.5.5 0 0 0 .491-.408l1.5-8A.5.5 0 0 0 14.5 3H2.89l-.405-1.621A.5.5 0 0 0 2 1zm3.915 10L3.102 4h10.796l-1.313 7zM6 14a1 1 0 1 1-2 0 1 1 0 0 1 2 0m7 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0"/>
            </svg>
      ...
      <div className="container mt-4">
        ...
        {filteredItems.map((item) => (
            <div className="col-md-4" key={item._id} id='card'>
              <div className="card mb-4 shadow-sm shadow-sm border border-primary">
                <Link to={`/store-items/${item._id}`} id='item-link'>
                  <img src={item.photo} className="card-img-top" alt={item.name} id='pics' />
                </Link>
                <div className="card-body">
                  <h5 className="card-title text-white">{item.name}</h5>
                  <p className="card-text text-white"><strong>RS: {item.price.toFixed(2)}</strong></p>
                  <p className="card-text text-white">Available: {item.qty}</p>
                  <button
                    className="btn btn-primaryx text-white"
