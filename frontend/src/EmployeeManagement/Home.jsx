  ...
  return (
    ...
    <div className="bg-gray-100 p-5 rounded-lg shadow-lg">
      ...
      <div className="flex justify-around p-3 mt-3">
        {/* Stats cards */}
        <div className="bg-gray-700 rounded-lg shadow-md p-5 text-center transform transition-transform hover:translate-y-1">
          <h4 className="mb-2 text-xl text-gray-200">Admins</h4>
          <hr />
        ...
        <div className="bg-gray-700 rounded-lg shadow-md p-5 text-center transform transition-transform hover:translate-y-1">
          <h4 className="mb-2 text-xl text-gray-200">Employee</h4>
          <hr />
          <div className="flex justify-between mt-2">
            <h5>Total:</h5>
        ...
        <div className="bg-gray-700 rounded-lg shadow-md p-5 text-center transform transition-transform hover:translate-y-1">
          <h4 className="mb-2 text-xl text-gray-200">Salary</h4>
          <hr />
          <div className="flex justify-between mt-2">
            <h5>Total:</h5>
            ...
            {admins.map(admin => (
              <tr key={admin.email} className="hover:bg-gray-200">
                ...
                <td className="p-4 border-b border-gray-300">
                  <button className="bg-green-600 text-white px-2 py-1 rounded-lg transition-transform transform hover:scale-105 mr-2">Edit</button>
                  <button className="bg-red-600 text-white px-2 py-1 rounded-lg transition-transform transform hover:scale-105">Delete</button>
                </td>
              </tr>
            ))}
          </tbody>
