      ...
      {loading ? (
        ...
        <div style={{
          ...
          <div style={{ margin: '1rem 0' }}>
            <span style={{ fontSize: '1.25rem', marginRight: '1rem', color: '#000000' }}>ID:</span>
            <span>{customer._id}</span>
          </div>
          <div style={{ margin: '1rem 0' }}>
            <span style={{ fontSize: '1.25rem', marginRight: '1rem', color: '#000000' }}>Name:</span>
          ...
          <div style={{ margin: '1rem 0' }}>
            <span style={{ fontSize: '1.25rem', marginRight: '1rem', color: '#000000' }}>Message:</span>
