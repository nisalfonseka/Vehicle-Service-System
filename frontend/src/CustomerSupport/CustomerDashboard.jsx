...
import CustomerOverview from "../CustomerSupport/CustomerOverview"; // Assuming you have a BookOverview component
...
function CustomerDashboard() {
  ...
  const renderComponent = () => {
    if (currentView === "overview") {
      return <CustomerOverview />; // Render BookOverview if "overview" is selected
    } else if (currentView === "dashboard") {
      return loading ? <Spinner /> : <CustomerCard customer={customer} />; // Render BookAdmin (BooksCard) if "dashboard" is selected
    }
  };
